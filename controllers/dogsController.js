...
module.exports = {
    ...
    // This method add user id into the dislikes array
    unlikeDog: function (req, res) {
        db.Dog.findOneAndUpdate({ _id: req.params.id }, { $push: { dislikes: req.params.likedId } })
            .then(dbModel => res.json(dbModel))
            .catch(err => res.status(422).json(err));
    },
    ...
    // This Method takes an obj and creates a new document on the collection
